...
class LibraryDatabase{
  ...
  Future<void> updateBookQuantityWhenBorrowOrEnded(Library library, Book book, int value) async{
    final database = booksDatabase.getFirestore()!.collection("libraries");
    QuerySnapshot<Map<String, dynamic>>? querySnapshot;
    ...
    if( libraries.isNotEmpty ){
      ...
      if(bookQuantity.containsKey(book.bookID)){
        bookQuantity[book.bookID] = (int.parse(bookQuantity[book.bookID]!) + value).toString();
      }
