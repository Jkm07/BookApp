            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  height: kIsWeb ? scaleHeight * 12 : scaleHeight * 7,
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                    ),
                ...
                Container(
                  padding: const EdgeInsets.all(5),
                  width: kIsWeb ? scaleHeight * 12 : scaleHeight * 7,
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                    ),
                ...
                space(),
                universalContainer("UserID", user.userID, scaleHeight * 3),
                space(),
                universalContainer("Email", user.userMail, scaleHeight * 3),
                space(),
                Container(
                  padding: const EdgeInsets.all(5),
                  decoration: BoxDecoration(
                  ...
                  child: DropdownButton<String>(
                      ...
                      onChanged: (item) async {
                        await userDatabase.changePermissions(
                            widget.user.userMail, item!);
                        await getParameters();
                        setState(() {
                          selectedItem = item;
                        });
